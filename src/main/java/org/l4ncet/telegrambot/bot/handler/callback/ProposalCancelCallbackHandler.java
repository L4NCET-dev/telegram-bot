...
public class ProposalCancelCallbackHandler implements CallbackHandler {

    private static final String CALLBACK_PREFIX = "PROPOSAL_CANCEL:";
    ...
    public void handle(Update update) {
        ...
        telegramMessageService.sendMessage(chatId, "Подання заявки скасовано");
